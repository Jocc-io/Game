...
import BreakBricksGame from '@/components/break-bricks-game';
import WalletContextProvider from '@/components/wallet-context-provider';
import TokenDisplay from '@/components/token-display';
import Footer from '@/components/footer';
import BreakBricksBackground from '@/Backgrounds/BreakBricksBackground';
        ...
        {!gameActive && !gameOver && (
          <div className="flex flex-col items-center gap-6">
            {!connected ? (
              ...
              <>
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center mb-2">
                  <img
