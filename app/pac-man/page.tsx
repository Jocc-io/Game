...
import PacmanBackground from '@/Backgrounds/PacmanBackground';
        ...
        {!gameActive && !gameOver && (
          <div className="flex flex-col items-center gap-6">
            {!connected ? (
              ...
              <>
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-500 to-orange-600 flex items-center justify-center mb-2">
                  <img
