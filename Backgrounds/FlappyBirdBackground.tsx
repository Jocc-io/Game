...
export default function FlappyBirdBackground() {
    ...
    <div className="fixed inset-0 overflow-hidden bg-black">
      ...
      {particles.map((p, i) => (
        <div
          ...
          style={{
            ...p,
            boxShadow: "0 0 10px #ec4899, 0 0 20px #db2777",
          }}
        />
      ))}
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          ...
          style={{
            top: `${(i + 1) * 15}%`,
            background:
              "linear-gradient(90deg, transparent, #ec4899, #db2777, #f472b6, transparent)",
