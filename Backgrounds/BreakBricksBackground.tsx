...
export default function BreakBricksBackground() {
    ...
    <div className="fixed inset-0 overflow-hidden bg-black">
      ...
      {particles.map((p, i) => (
        <div
          ...
          style={{
            ...p,
            boxShadow: "0 0 10px #3b82f6, 0 0 20px #2563eb",
          }}
        />
      ))}
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          ...
          style={{
            top: `${(i + 1) * 15}%`,
             background:
              "linear-gradient(90deg, transparent, #3b82f6, #2563eb, #60a5fa, transparent)",
